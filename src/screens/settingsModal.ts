          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="form-group">
              ...
              <span style="font-size: 11px; color: var(--text-muted); margin-top: 4px;">
                Default ID: <code>${DEFAULT_CLIENT_ID}</code>. To show custom app titles or art assets, create an app at 
                <a href="https://discord.com/developers/applications" target="_blank" style="color: var(--text-link);">Discord Developer Portal</a>.
              </span>
            </div>
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0;">
              <div>
                ...
                <div style="font-size: 12px; color: var(--text-muted);">Automatically start status manager when Windows boots</div>
              </div>
              <input type="checkbox" id="chk-autostart" ${this.settings.autostart ? "checked" : ""} style="width: 18px; height: 18px; cursor: pointer;">
            </div>
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0;">
              ...
              <input type="checkbox" id="chk-minimized" ${this.settings.start_minimized ? "checked" : ""} style="width: 18px; height: 18px; cursor: pointer;">
            </div>
          </div>
